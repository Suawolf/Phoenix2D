...
void createFuzzy(){
	...
	v->addMembershipFunction("tired",       new Math::RampDesc(0.76, 0.9));
	v->addMembershipFunction("fresh",       new Math::RampAsc(0.8, 0.9));
	...
	v->addMembershipFunction("slow",        new Math::Trapezoidal(-0.1, 0.0, 1.0, 2.0));
	...
	v->addMembershipFunction("farLeft",    	new Math::RampDesc(-45.0, -15.0));
	v->addMembershipFunction("left",        new Math::Trapezoidal(-45.0, -15.0, -15.0, 0.0));
	v->addMembershipFunction("center",      new Math::Trapezoidal(-15.0, 0.0, 0.0, 15.0));
	v->addMembershipFunction("right",       new Math::Trapezoidal(0.0, 15.0, 15.0, 45.0));
	v->addMembershipFunction("farRight",  	new Math::RampAsc(15.0, 45.0));
	...
	v->addMembershipFunction("left",        new Math::Trapezoidal(-60.0, -45.0, -25.0, -0.0));
	v->addMembershipFunction("straight",    new Math::Trapezoidal(-10.0, 0.0, 0.0, 10.0));
	v->addMembershipFunction("right",       new Math::Trapezoidal(0.0, 25.0, 45.0, 60.0));
	...
	v->addMembershipFunction("aLeft",  	 	new Math::RampDesc(-90.0, -50.0));
	v->addMembershipFunction("dLeft",  		new Math::Trapezoidal(-60.0, -45.0, -15.0, 0.0));
	v->addMembershipFunction("face",        new Math::Trapezoidal(-45, 0.0, 0.0, 45.0));
	v->addMembershipFunction("dRight", 		new Math::Trapezoidal(0.0, 15.0, 45.0, 60.0));
	v->addMembershipFunction("aRight", 		new Math::RampAsc(50.0, 90.0));
	fStage3Stay.addVariable(v);
	v = new FVariable("strafe", -90.0, 90.0);
	v->addMembershipFunction("aLeft",  	 	new Math::RampDesc(-90.0, -50.0));
	v->addMembershipFunction("dLeft",  		new Math::Trapezoidal(-60.0, -45.0, -15.0, 0.0));
